...
const Playmat4: React.FC<PlaymatProps> = ({
  layout,
  myPID,
  names,
  discardImages = [],
  ...
  return (
    <div className="playing-mat-outline-4-players" data-my-pid={myPID}>
      <img className="backdrop" src={backdrop} alt="4-player backdrop" />
